...
<main class="browse-page container">
    ...
    <h3>Categories</h3>
                <ul>
                <li><a href="browse.php" <?php if ($selectedCategory == null) echo 'class="active"'; ?>>All</a></li>
                <?php foreach ($categories as $category) : ?>
                    <li><a href="browse.php?category_id=<?php echo $category['category_id']; ?>" 
                           <?php if ($category['category_id'] == $selectedCategory) echo 'class="active"'; ?>>
