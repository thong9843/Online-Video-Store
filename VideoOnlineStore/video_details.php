...
if (isset($_GET['video_id'])) {
    ...
    $releaseDay = getVideoById($conn, $videoId);
...
<main class="video-detail">
    <section class="video-details container">
        ...
        <p><strong>Release day:</strong> <?php echo htmlspecialchars($releaseDay['release_day'], ENT_QUOTES, 'UTF-8'); ?></p>

        <?php if ($videoDetails['is_video']): ?>
        <p><strong>Duration:</strong> <?php echo formatDuration($videoDetails['duration']); ?></p>
        ...
        <p><strong>Actors:</strong> <?php echo implode(", ", array_unique($videoDetails['actor_names'])); ?></p>
        <p><strong>Categories:</strong> <?php echo implode(", ", array_unique($videoDetails['category_names'])); ?></p>
